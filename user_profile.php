...
<head>
    ...
    ?>
    <title><?php echo 'People Profile | '.$user_name;?></title>
                    ...
                    <div>
                        <?php
                         if (isset($_GET['u_id'])){
                             ...
                             $get_users = "SELECT * FROM users WHERE user_id = '$get_user_id'";
                             $get_users_result = mysqli_query($conn,$get_users);
                             $get_users_num = mysqli_num_rows($get_users_result);
                             if ($get_users_num == 1){
                                 $get_users_row = mysqli_fetch_array($get_users_result);
                                 $get_first_name = $get_users_row['first_name'];
                                 $get_last_name = $get_users_row['last_name'];
                                 $get_description = $get_users_row['description'];
                                 $get_gender = $get_users_row['gender'];
                                 $get_relationship = $get_users_row['relationship'];
                                 $get_country = $get_users_row['country'];
                                 $get_dob = $get_users_row['dob'];
                             }
                         }
                        ?>
                        <p class="text-white">Name : <strong><?php echo $get_first_name.' '.$get_last_name?></strong></p>
                        <p class="text-white">Description : <code class="text-white font-weight-bold"><?php echo $get_description;?></code></p>
                        <p class="text-white">Gender : <code class="font-weight-bold text-white"><?php echo $get_gender;?></code></p>
                        <p class="text-white">Relationship : <code class="text-white font-weight-bold"><?php echo $get_relationship;?></code></p>
                        <p class="text-white">Live In : <code class="text-white font-weight-bold"><?php echo $get_country;?></code></p>
                        <p class="text-white">Date OF Birth : <code class="text-white font-weight-bold"><?php echo $get_dob;?></code></p>
                    </div>
                </div>
